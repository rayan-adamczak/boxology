 ...
 *
 * `Record<NomAxe, …>` et non un objet libre : un axe ajouté à `regroupements.ts`
 * casse la compilation ici au lieu de rendre une puce sans intitulé. C'est ce
 * qui a rattrapé l'arrivée de `collections` à la fusion.
 */
